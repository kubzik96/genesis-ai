...
> Этот документ является только Draft Specification.  
> Его публикация в Draft PR не изменяет статусы T-009/T-010, не создаёт DR-0006, не назначает Codex на официальную роль и не разрешает реализацию или merge.  
> Approval спецификации и Execution Authorization являются отдельными решениями CEO.
...
- [ ] Эта Draft Specification не создаёт и не принимает DR-0006.
