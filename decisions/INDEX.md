...
- формат имени файла: `DR-XXXX.md` или `DR-XXXX-Short-Name.md`, где суффикс является необязательным кратким названием;
...
| [DR-0012](DR-0012-Universal-Adaptive-Agent-Orchestration-Architecture.md) | Universal Adaptive Agent Orchestration Architecture | Предложено | 2026-09-12 |
