...
- **Актуальный ориентир main (после PR #16):** `d3ed88ae0fe86ec284375b9ca54ba018dff2062f`
- **Главная цель:** управляемая ИИ-команда для проектирования, разработки и сопровождения продуктов

---

## Участники (актуальные)
...
Устаревшее: «ChatGPT временно CTO» — **снято** с оперативного статуса; роль CTO в отборе.
